...
public class AdminKafkaResource {

    private final Logger log = LoggerFactory.getLogger(AdminKafkaResource.class);
    ...
    public AdminKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
